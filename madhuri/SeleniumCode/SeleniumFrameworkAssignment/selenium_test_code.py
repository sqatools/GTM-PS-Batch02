...
# send_data(billing_name_locator, "Madhuri")
# send_data(billing_phone_locator, billing_phone)
# send_data(billing_email_locator, billing_email)
# send_data(billing_address_locator, billing_address)
# send_data(billing_country_locator, billing_country)
