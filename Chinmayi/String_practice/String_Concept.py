...
output_1 = "Hi Everyone I am " + name +" and my age is "+str(age)+" and i stay in "+city
print(output_1)
...
output_2 = "Hi Everyone I am {} and my age is {} and i stay in {}".format( name,age,city)
print(output_2)
...
output_3 = f"Hi Everyone I am {name} and my age is {age} and i stay in {city}"
print(output_3)
