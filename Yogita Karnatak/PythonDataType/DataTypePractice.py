...
val = 4+5j
val2 = 435435 + 5.6j
print(val, type(val)) # (4+5j) <class 'complex'>
...
->List follows the similar positive & negative indexing as like String.
->All type of data can store in the list like int, float,string, boolean, dict list, tuple etc.
