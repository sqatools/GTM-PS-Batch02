...
#6
brandfilter_locator=(By.XPATH,"(//div//i[@class='a-icon a-icon-checkbox'])[8]")
rangefilter_locator=(By.XPATH,"//span[text()='₹1,000 - ₹2,500']")
alldiscount_locator=(By.ID,"p_n_deal_type/26921226031")
size_locator=(By.ID,"a-autoid-47-announce")
color_locator=(By.ID,"//li[@id='p_n_size_two_browse-vebin/2022304031']")
